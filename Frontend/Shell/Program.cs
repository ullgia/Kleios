using Kleios.Frontend.Shell.Components;
...
// Map Razor Components from this app and shared components
app.MapRazorComponents<App>()
    .AddAdditionalAssemblies(typeof(Kleios.Frontend.Components.Layout.MainLayout).Assembly);
