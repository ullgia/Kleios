// filepath: c:\Users\Giacomo\source\Kleios\Frontend\Modules\Kleios.Modules.Auth\Handlers\AuthenticationDelegatingHandler.cs
...
/// <summary>
/// Handler HTTP che gestisce automaticamente l'autenticazione e il refresh dei token
/// </summary>
        ...
        if (response.StatusCode == HttpStatusCode.Unauthorized)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        // Risolviamo l'AuthService on-demand per evitare la dipendenza circolare
                        var authService = _serviceProvider.GetService(typeof(IAuthService)) as IAuthService;
                        if (authService != null)
                        {
