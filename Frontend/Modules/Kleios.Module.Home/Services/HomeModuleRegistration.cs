...
/// </summary>
public class HomeModuleRegistration : BackgroundService
{
    private readonly ILogger<HomeModuleRegistration> _logger;
    private readonly IConfiguration _configuration;
    private readonly GatewayConnectionClient _gatewayClient;
    private readonly string _gatewayUrl;
    private readonly IHostEnvironment _environment;

    public HomeModuleRegistration(
        ILogger<HomeModuleRegistration> logger,
